    ...
    <Card className="mb-3">
      <CardBody className="rounded-soft bg-gradient">
        <Row className="text-white align-items-center no-gutters">
          <Col>
            <h4 className="text-white mb-0">Historical DSA Creation</h4>
            <p className="fs--1 font-weight-semi-bold">
              Total <span className="opacity-50">$684.87</span>
            </p>
          </Col>
        ...
        <Line data={config.data} options={config.options} width={1618} height={400} />
      </CardBody>
    </Card>
  );
};
