...
export {  getGlobalDsaCount, getAccounts, getAuthorizedAddresses, getBalances, getCompoundPosition, getMakerPosition, getAavePosition, getDydxPosition /*getLatestTxns*/ };